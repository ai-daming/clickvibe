            ...
            return {
              ...
              stdout: {
                text: [
                  ...
                  'r-issue-106',
                  'CLICKVIBE_WORKFLOW_GIT_BASE_BRANCH',
                  'main',
                  'CLICKVIBE_WORKFLOW_GIT_REFS',
                  'refs/heads/main\tabc1234\t\t0 1',
                  'refs/remotes/origin/main\tabc1234\t\t0 1',
                  'refs/remotes/origin/HEAD\tabc1234\torigin/main\t0 1',
                  'refs/heads/r-issue-106\tabc1234\t\t0 0',
                  'CLICKVIBE_WORKFLOW_GIT_FALLBACK_BASE',
                  'CLICKVIBE_WORKFLOW_GIT_HAS_COMMITS',
                  '1',
